                ...
                <div className="flex w-full">
                    <div className="flex flex-col gap-6 p-10 text-4xl font-semibold md:m-auto md:p-0 md:text-6xl">
                        ...
                        <span className="text-justify text-base font-normal opacity-85 md:text-xl">
                            ...
                            Tracker, your ultimate expense tracking app designed
                            to simplify and streamline your financial
                            management. With{" "}
                            <span className="text-blue-600 opacity-100">
                                Expense
                            </span>
                            Tracker, effortlessly monitor your spending,
                            categorize expenses, and gain insights into your
                            financial habits. Our intuitive interface allows you
                            to track transactions in real-time, set budget
                            limits, and receive alerts to help you stay within
                            your means.
                        </span>
                        <div>
                            <Button
